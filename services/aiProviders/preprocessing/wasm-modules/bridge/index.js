...
Object.defineProperty(exports, "ErrorCode", { enumerable: true, get: function () { return types_1.WASMErrorCode; } });
Object.defineProperty(exports, "VulnerabilitySeverity", { enumerable: true, get: function () { return types_1.VulnerabilitySeverity; } });
// Export mock web streaming bridge for testing
exports.webStreamingBridge = {
    analyzeStream: async (stream, options) => {
    ...
    analyzeBatch: async (buffers, options) => {
        const results = [];
