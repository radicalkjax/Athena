...
impl Disassembler {
    pub fn disassemble(
        ...
        match arch {
            ...
            Architecture::Arm => {
                result = crate::arm_disasm::ArmDisassembler::disassemble_arm32(code, offset, max_instructions)?;
            }
            Architecture::Arm64 => {
                result = crate::arm_disasm::ArmDisassembler::disassemble_arm64(code, offset, max_instructions)?;
            }
        }
